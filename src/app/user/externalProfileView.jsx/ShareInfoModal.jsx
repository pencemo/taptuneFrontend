...
//   ScanLine,
// } from "lucide-react";
// import ScanCardModal from "./scanning/ScanCardModal";
...
//     setFormData((prev) => ({
//       ...prev,
//       // Only update if scanned data exists, otherwise keep existing
//       fullName: scannedData.name || prev.fullName,
//       // Note: react-phone-number-input expects standard format,
//       // scanner might return "999, 888", so we take the first one or clean it
//       phone: scannedData.phoneNumber
//         ? scannedData.phoneNumber.split(",")[0].trim()
//         : prev.phone,
//     }));
...
//         }}
//       >
//         <DialogContent className="flex flex-col gap-0 p-0 w-[95vw] sm:w-full sm:max-w-lg max-h-[90vh] rounded-xl overflow-hidden">
...
//             {/* --- SCAN BUTTON --- */}
//             <div className="mb-6 bg-purple-50 p-4 rounded-xl border border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-sm">
...
//                           className="flex items-center gap-2"
//                         >
//                           <PhoneInput className="w-3.5 h-3.5 text-gray-500 hidden" />{" "}
//                           Business Phone
//                         </Label>
//                         <CustomPhoneInput
//                           id="businessPhone"
...
//           <DialogFooter className="p-6 pt-4 border-t bg-gray-50/50 sm:bg-white flex-col sm:flex-row gap-3">
//             <Button
//               type="button"
//               variant="ghost"
//               onClick={onClose}
...
//               className="w-full sm:w-auto order-1 sm:order-2 bg-purple-600 hover:bg-purple-700 text-white shadow-md transition-all hover:shadow-lg"
//               disabled={loading}
//             >
//               {loading ? (
//                 <>
